...
export const CommunityPage: React.FC = () => {
  ...
  const handleCreatePost = async (e: React.FormEvent) => {
    ...
    try {
      const res = await api.createPost({ content: newPostContent });
    ...
    <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in duration-300">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-slate-900/80 border border-white/[0.08] shadow-xl">
        ...
        <p className="text-xs sm:text-sm text-slate-400 mt-1">
          A tranquil feed to share spiritual milestones, inspire consistency, and make du’a for one another.
        </p>
      </div>
            ...
            <div className="flex items-start space-x-3.5">
              ...
              <div className="flex-1">
                <textarea
                  ...
                  placeholder="Share a milestone, Ayah reflection, or dua for the community..."
                ...
                <div className="flex items-center justify-between mt-3">
                  <span className="text-xs text-slate-500">
                    Keep posts respectful, uplifting, and centered on Allah.
                  </span>
                  <button
                    type="submit"
        ...
        {isLoading ? (
          ...
          posts.map((post) => {
            ...
            return (
              <div
                key={post.id}
                className="p-6 rounded-3xl bg-slate-900/80 border border-white/[0.08] shadow-lg hover:border-slate-700 transition-all space-y-4"
              >
                {/* Author Info */}
                    ...
                    {isAuthenticated && (
                      <div className="flex items-center space-x-2 pt-1">
                        ...
                        <button
                          ...
                          className="px-3 py-2 rounded-xl bg-emerald-500 text-slate-950 font-bold text-xs hover:bg-emerald-400 transition-colors"
                        >
                          Reply
                        </button>
                      </div>
