    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="mt-6 pt-4 border-t border-slate-800">
          <p className="text-center text-[11px] font-semibold text-slate-400 mb-2.5 uppercase tracking-wider">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center space-x-1.5 p-2 rounded-xl bg-slate-800/60 hover:bg-slate-800 border border-slate-700/80 text-xs font-semibold text-slate-200 transition-colors"
            >
              <Sparkles className="w-3.5 h-3.5 text-emerald-400" />
              <span>Adnan (User)</span>
            </button>
            ...
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center space-x-1.5 p-2 rounded-xl bg-slate-800/60 hover:bg-slate-800 border border-slate-700/80 text-xs font-semibold text-amber-300 transition-colors"
            >
              <ShieldCheck className="w-3.5 h-3.5 text-amber-400" />
              <span>Bilal (Admin)</span>
            </button>
          </div>
        </div>
      </div>
