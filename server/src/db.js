...
const dbPath = path.resolve(__dirname, '../majlis.db');
...
export const initDb = async () => {
  ...
  await run(`
    CREATE TABLE IF NOT EXISTS prayer_records (
      ...
      status TEXT NOT NULL, -- 'completed', 'missed', 'late', 'excused'
      notes TEXT,
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  ...
  await run(`
    CREATE TABLE IF NOT EXISTS community_posts (
      ...
      post_type TEXT DEFAULT 'general', -- 'streak', 'milestone', 'quran_goal', 'general'
      badge_info TEXT,
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
      FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
    )
  ...
  await run(`
    CREATE TABLE IF NOT EXISTS post_reactions (
      ...
      user_id INTEGER NOT NULL,
      reaction_type TEXT DEFAULT 'barakallah', -- 'barakallah', 'mashallah', 'mabrook', 'heart'
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
